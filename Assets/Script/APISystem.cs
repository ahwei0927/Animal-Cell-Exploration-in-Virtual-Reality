...
public class APISystem : MonoBehaviour
{
    ...
    const string token = "52d38d5d22e81cd504e8261540c3e3f8";
    const string leaderboard_id = "LB_rough";

    public ContainerA containerA; //user details
    public ContainerB containerB; //leaderboard details

    public void GetLeaderboardRough()
    {
        StartCoroutine(GetLeaderboardRoughController());
    }
    ...
    private IEnumerator GetLeaderboardRoughController()
    {
