...
MonoBehaviourPunCallbacks, IPunObservable, IPunOwnershipCallbacks 
        ...
        [Tooltip("Transform of the remote player's head. This will be updated during Update")]
        public Transform RemoteBodyTransform;
        ...
        void Update() {
            ...
            if (!photonView.IsMine) {
                ...
                updateRemotePositionRotation(RemoteBodyTransform, _syncBodyStartPosition, _syncBodyEndPosition, _syncBodyStartRotation, _syncBodyEndRotation, synchValue);
        ...
        public void AssignPlayerObjects() {
            ...
            PlayerBodyTransform = player.transform;
        ...
        public void AssignPlayerObjects(GameObject Root)
        {

            PlayerHeadTransform = getChildTransformByName(Root.transform, "CenterEyeAnchor");
            PlayerBodyTransform = Root.transform;
        ...
        void toggleObjects(bool enableObjects) {
            ...
            RemoteBodyTransform.gameObject.SetActive(enableObjects);
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info) {
            ...
            if (stream.IsWriting) {
                ...
                stream.SendNext(PlayerBodyTransform.position);
                stream.SendNext(PlayerBodyTransform.rotation);
                ...
                // Body
                this._syncBodyStartPosition = RemoteBodyTransform.position;
                this._syncBodyEndPosition = (Vector3)stream.ReceiveNext();
                this._syncBodyStartRotation = RemoteBodyTransform.rotation;
